...
cl = LINETCR.LINE()
cl.login(token='ErATfBOk9rQlQJQUBr42.cgM2mbGybJNV6ZLunKEEaG.V60Pqpbqh3FuIynViJhTyYlGQRbXMOhqZBL0kMDCl/0=')
cl.loginResult()
...
ki = LINETCR.LINE()
ki.login(token='Erm7ffMERuNDoD4WLj67.DlqRyKJ45By6qR51/9HR5W.VPpAAD3nkvYoWi3t2DI4Ef85ptJGzg0t22OSCi/Fc0s=')
ki.loginResult()
...
kk = LINETCR.LINE()
kk.login(token='ErpOvWH2YIUmr6Gw4gBf.XZz8P6CsX90xK88xL2AVVW.5ip4ZUyPz4dJ/orob+/mzS1kD+LTyuMEl7wU9oibXP0=')
kk.loginResult()
...
ks = LINETCR.LINE()
ks.login(token='Erw5KiS1upc8mtAtVSab.0cO2i9McKyZSokcFO8Tp/W.9xJ1Hzh9YNJKuN9EMv+yDJ+RznL674A0Jj48a4hoq4k=')
ks.loginResult()

print "╔══════════════Login Sucsses ══════════════╗\n   🇲🇨 Gunakan Bot Sebijak Mungkin\n   🇲🇨 Jangan Sombomg Pakai Bot Orang Lain\n╚═══════════════════════════════════════════╝\n              ╔══════════════╗\n               🛡 GYE_VHA 🛡   \n              ╚══════════════╝"
reload(sys)
sys.setdefaultencoding('utf-8')
...
admin = ["uc38e086fd9e30cb21396c99eb1e06102","u0869b63018180639efeb395436479e02"]
...
Rx2 = ["uc7367ca7a712c7dd1793cf179766afbf"]
Rx1 = ["ud02a3623d982918cec38a09fa3cb4ffb"]
Administrator = admins + Rx3 + Rx2 + Rx1
AS = Rx2 + Rx1 + Rx3
adminsA = admins + Rx3

omikuzi = ["Gye_Vha_Bhot"]
...
wait = {
    ...
    "lang":"JP",
    "comment":"💫Auto like ☢GyeVha☢  http://line.me/ti/p/~gyegyegyew  ",
    "likeOn":False,
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
...
#--------------------------------------------------------
                ...
                if wait["leaveRoom"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Turned off。")
            elif msg.text in ["共有:オン","共有：オン","Share n"]:
                if wait["timeline"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already on")
                    else:
            ...
            elif msg.text in ["Bye","Keluar","Pergi"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
...
#----------------------------------------------------------
            elif msg.text in ["Beph","respon","Absen","responsename"]:
...
#-----------------------------------------------
                ...
                start = time.time()
                cl.sendText(msg.to, "Sabar Broo Proses...!!")
